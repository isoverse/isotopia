# isotopia
[![Build Status](https://travis-ci.org/sebkopf/isotopia.svg)](https://travis-ci.org/sebkopf/isotopia)
[![codecov.io](https://codecov.io/github/sebkopf/isotopia/coverage.svg?branch=master)](https://codecov.io/github/sebkopf/isotopia?branch=master)
...
The [**isotopia**](https://github.com/sebkopf/isotopia) R module can be installed directly from [GitHub](https://github.com/), by using the R development tools module (Wickham and Chang, 2014). A word of caution that isotopia is still under active development and development versions include additional functionality with syntax that might not be backwards compatible. This tutorial is available [directly in this repository](vignettes/isotopia.Rmd) including the resulting [HTML output](https://rawgit.com/sebkopf/isotopia/master/inst/doc/isotopia.html), and also as a vignette directly in the package and will be updated as new versions are released. Please use the [Issue Tracker](https://github.com/sebkopf/isotopia/issues) to report any problems, bugs or feature requests. 
